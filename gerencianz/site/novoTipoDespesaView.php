...
$newdes = '
    <div class="ls-form ls-form-horizontal">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="ls-table ls-bg-header" id="tbDespesas">
                    <thead>
                        <tr>
                            <th>Descrição</th>
                            <th></th>
    ...
    <div class="ls-modal" id="modalCadastro" data-ls-module="form">
        <div class="ls-modal-large">
            <div class="ls-modal-header">
                ...
                <h4 class="ls-modal-title">Tipo de Despesa</h4>
            </div>
            ...
            <div class="ls-modal-footer">
                ...
                <div class="ls-float-right">
                    ...
                    <input type="button" class="ls-btn-primary " id="btnSalvar" name="btnSalvar" value="Salvar" onclick="salvarTipoDespesa()">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ls-modal" id="modalCadastroSubtipo" data-ls-module="form">
        <div class="ls-modal-large">
            <div class="ls-modal-header">
                <button data-dismiss="modal">&times;</button>
                <h4 class="ls-modal-title">Subtipo de Despesa</h4>
            </div>
            <div class="ls-modal-body">
                <div class="ls-form ls-form-horizontal">
                    <div class="row">
                        ...
                        <label class="ls-label col-md-12 col-xs-10">
                            <b class="ls-label-text">Tipo de Despesa</b>
            ...
            <div class="ls-modal-footer">
                ...
                <div class="ls-float-right">
                    <input type="button" class="ls-btn" data-dismiss="modal" value="Cancelar">
                    <input type="button" class="ls-btn ls-btn-primary" id="btnSalvarSubtipo" name="btnSalvarSubtipo" value="Salvar" onclick="salvarSubtipoDespesa()">
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
		...
		{
			$("#tbDespesas .trId").each(function(){
				$(this).remove();	
			});
			$.ajax({
				type: "POST",
				data: { filtroTipoDespesa : $("#txtFiltro").val() },
				url: "../utils/post.php",
				success: function(dados) { 
					if(dados){
						obj = JSON.parse(dados);
						obj.forEach(function(item){
							var newRow = $("<tr class=\'trId\' id=\'des"+item.cod+"\'>");	    
							var cols = "";
			...
			if(erros == 0)
                $.ajax({
                    ...
                    success: function(dados) {
                        ...
                        {
                            obj = JSON.parse(dados);
                            $("#alertasModalTitulo").html("Tipo de Despesa");
            ...
            if(cont == 0)
            {
                ...
                $.ajax({
                    ...
                    success: function(dados) {
                        ...
                        {
                            obj = JSON.parse(dados);
                            $("#alertasModalTitulo").html("Subtipo de Despesa");
                            $("#alertasModalTexto").html(obj.retorno);
                            $("#alertasModal").show();
                            if(obj.condicao)
                            {
